        ...
        <div className='app__header flex'>
                ...
                <div className='app__header-badge'>
                    <div className='badge-cmp app__flex'>
                        ...
                        <div className='ml-4'>
                            ...
                            <h1 className='head-text'>Walling</h1>
                        </div>
                    </div>
            ...
            <motion.div whileInView={{ opacity: [0, 1] }}
                ...
                <div className='w-full invisible lg:visible absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 px-8 z-10'>
                    <h1 className='text-6xl text-center font-black'>The Walling App</h1>
                    <p className='mt-8 w-1/2 text-2xl text-center mx-auto'>Want to keep track your events. Try Walling to help you write for enjoying your moments</p>
